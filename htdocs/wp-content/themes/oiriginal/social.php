...
<li class="fe"><a href="http://feedly.com/index.html#subscription%2Ffeed%2Fhttps%3A%2F%2web-diy.jp%2Ffeed%2F" target="blank"><i class="fa fa-rss"></i>feedly<span class="sns_count"><?php if(function_exists('scc_get_follow_feedly')) echo (scc_get_follow_feedly()==0)?'0':scc_get_follow_feedly(); ?></span></a></li>
</ul>
</dd>
</dl>
</div>