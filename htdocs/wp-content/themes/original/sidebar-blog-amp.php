...
<ul class="whatsnew">
<?php $posts=get_posts('numberposts=5 & category=0'); ?>
<?php if ( $posts ) : foreach($posts as $post) : setup_postdata($post); ?>
<li><a href="<?php the_permalink();?>"><?php if ( has_post_thumbnail() ) : ?><?php $img_id = get_post_thumbnail_id();$img_thumbnail = wp_get_attachment_image_src( $img_id , 'thum300' );echo '<amp-img width="80" height="80" src="'.$img_thumbnail[0].'" alt=""></amp-img>';?><?php else: ?><?php endif; ?><span class="txt"><?php the_title(); ?></span><p><span class="cat"><?php $category = get_the_category();echo $category[0]->cat_name;?></span><?php the_time('Y年n月j日'); ?></p></a></li>
<?php endforeach; endif; ?></ul>
<p class="title-blog mt30"><span>記事を書いている人</span></p>
<p class="align-C"><amp-img width="138" height="138" src="/shared/images/profile.png" alt=""></amp-img></p>
<ul class="list-info">
...
<p class="title-blog mt30"><span>人気の記事</span></p>
<ol class="rank">
<?php $posts = get_posts(array('posts_per_page' => 5,'meta_key' => 'views','orderby' => 'meta_value_num',)); ?>
<?php foreach($posts as $post) : ?>
<li><a href="<?php the_permalink();?>"><?php if (has_post_thumbnail()):?><?php $img_id = get_post_thumbnail_id();$img_thumbnail = wp_get_attachment_image_src( $img_id , 'thum300' );echo '<amp-img width="80" height="80" src="'.$img_thumbnail[0].'" alt=""></amp-img>';?><?php else: ?><?php endif; ?><span class="txt"><?php the_title(); ?></span><p><span class="cat"><?php $category = get_the_category();echo $category[0]->cat_name;?></span><?php the_time('Y年n月j日'); ?></p></a></li>
<?php endforeach;wp_reset_postdata(); ?>
</ol>
<p class="title-blog mt30"><span>過去の記事</span></p>
<dl class="archive">
<?php
